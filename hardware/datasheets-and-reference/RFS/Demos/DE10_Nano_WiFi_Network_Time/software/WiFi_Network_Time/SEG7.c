...
#define SEG7_SET(index, seg_mask) \
    IOWR(SEG7_IF_0_BASE, (index), (seg_mask))
#define SEG7_NUM    6

static unsigned char szMap[] = { 63, 6, 91, 79, 102, 109, 125, 7, 127, 111, 119,
        124, 57, 94, 121, 113 };  // 0,1,2,....9, a, b, c, d, e, f
