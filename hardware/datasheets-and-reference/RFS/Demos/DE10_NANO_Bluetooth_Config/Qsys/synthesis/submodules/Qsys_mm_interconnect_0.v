...
module Qsys_mm_interconnect_0 (
	...
	wire  [94:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [94:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [94:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> timer_0_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // timer_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> timer_0_s1_agent:cp_channel
	...
	wire  [18:0] hc_05_uart_s1_agent_m0_address;                                                     // hc_05_uart_s1_agent:m0_address -> hc_05_uart_s1_translator:uav_address
	...
	wire  [95:0] hc_05_uart_s1_agent_rf_source_data;                                                 // hc_05_uart_s1_agent:rf_source_data -> hc_05_uart_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] hc_05_uart_s1_agent_rsp_fifo_out_data;                                              // hc_05_uart_s1_agent_rsp_fifo:out_data -> hc_05_uart_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> hc_05_uart_s1_agent:cp_valid
	wire  [94:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> hc_05_uart_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // hc_05_uart_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> hc_05_uart_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> hc_05_uart_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> hc_05_uart_s1_agent:cp_endofpacket
	...
	wire  [18:0] pio_key_s1_agent_m0_address;                                                        // pio_key_s1_agent:m0_address -> pio_key_s1_translator:uav_address
	...
	wire  [95:0] pio_key_s1_agent_rf_source_data;                                                    // pio_key_s1_agent:rf_source_data -> pio_key_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] pio_key_s1_agent_rsp_fifo_out_data;                                                 // pio_key_s1_agent_rsp_fifo:out_data -> pio_key_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> pio_key_s1_agent:cp_valid
	wire  [94:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_key_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // pio_key_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_key_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> pio_key_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> pio_key_s1_agent:cp_endofpacket
	...
	wire  [94:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [94:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [94:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire         hc_05_uart_s1_agent_rp_valid;                                                       // hc_05_uart_s1_agent:rp_valid -> router_006:sink_valid
	wire  [94:0] hc_05_uart_s1_agent_rp_data;                                                        // hc_05_uart_s1_agent:rp_data -> router_006:sink_data
	wire         hc_05_uart_s1_agent_rp_ready;                                                       // router_006:sink_ready -> hc_05_uart_s1_agent:rp_ready
	wire         hc_05_uart_s1_agent_rp_startofpacket;                                               // hc_05_uart_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         hc_05_uart_s1_agent_rp_endofpacket;                                                 // hc_05_uart_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         pio_key_s1_agent_rp_valid;                                                          // pio_key_s1_agent:rp_valid -> router_007:sink_valid
	wire  [94:0] pio_key_s1_agent_rp_data;                                                           // pio_key_s1_agent:rp_data -> router_007:sink_data
	wire         pio_key_s1_agent_rp_ready;                                                          // router_007:sink_ready -> pio_key_s1_agent:rp_ready
	wire         pio_key_s1_agent_rp_startofpacket;                                                  // pio_key_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         pio_key_s1_agent_rp_endofpacket;                                                    // pio_key_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         hc_05_uart_s1_agent_rdata_fifo_src_valid;                                           // hc_05_uart_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] hc_05_uart_s1_agent_rdata_fifo_src_data;                                            // hc_05_uart_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         hc_05_uart_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_004:in_0_ready -> hc_05_uart_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> hc_05_uart_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> hc_05_uart_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // hc_05_uart_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> hc_05_uart_s1_agent:rdata_fifo_sink_error
	wire         pio_key_s1_agent_rdata_fifo_src_valid;                                              // pio_key_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] pio_key_s1_agent_rdata_fifo_src_data;                                               // pio_key_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         pio_key_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_005:in_0_ready -> pio_key_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> pio_key_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> pio_key_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // pio_key_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> pio_key_s1_agent:rdata_fifo_sink_error
