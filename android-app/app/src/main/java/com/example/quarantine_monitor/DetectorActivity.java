...
import com.example.quarantine_monitor.customview.OverlayView.DrawCallback;
import com.example.quarantine_monitor.env.BorderedText;
import com.example.quarantine_monitor.env.ImageUtils;
    ...
    builder.setPositiveButton("OK", new DialogInterface.OnClickListener(){
      ...
      public void onClick(DialogInterface dlg, int i) {
          ...
          showConfirmationDialogue("Successfully registered your facial profile",
                  "Please click the button below to be directed to the main page.", 2);
      }
    });
...
//    }
  ...
  /*
   * @desc: this function will show a confirmation dialogue after an event
   * */
  private void showConfirmationDialogue(String title, String message, Integer event) {
    AlertDialog.Builder builder = new AlertDialog.Builder(this);
              ...
              public void onClick(DialogInterface dialog, int id) {
                ...
                switch(event){
                  case 1: Log.d(TAG, "Need to register face, show explanation");
                    dialog.dismiss();
                    break;
                  case 2: Log.d(TAG, "Registration done, proceeding to main page");
                    startActivity(homePageIntent);
                    break;
                  case 3: Log.d(TAG, "Face detected successfully, showing explanation + returning to home page");
                    startActivity(homePageIntent);
                    break;
                  default: Log.d(TAG, "show explanation");
                    dialog.dismiss();
                    break;
                }
